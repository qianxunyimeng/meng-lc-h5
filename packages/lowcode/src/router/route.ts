    ...
    children: [
        ...
        children: [
          {
            ...
            children: [
              ...
              },
              {
                ...
                component: () =>
                  import('/@/views/limits/frontEnd/btn/index.vue'),
                meta: {
            ...
            children: [
              {
                ...
                component: () =>
                  import('/@/views/limits/backEnd/page/index.vue'),
                meta: {
      ...
      },
      {
        ...
        meta: {
          ...
          isIframe: false,
          roles: ['admin', 'common'],
          icon: 'iconfont icon-keshihuaguanli',
        },
        children: [
          {
                ...
                children: [
                  {
                    ...
                    name: 'menu121',
                    component: () =>
                      import('/@/views/menu/menu1/menu12/menu121/index.vue'),
                    meta: {
                  ...
                  },
                  {
                    ...
                    name: 'menu122',
                    component: () =>
                      import('/@/views/menu/menu1/menu12/menu122/index.vue'),
                    meta: {
