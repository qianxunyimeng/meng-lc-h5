    ...
    <div class="big-data-up">
      ...
      <div class="up-right">
        <el-dropdown size="small">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item v-for="(v, k) in state.dropdownList" :key="k"
                >{{ v.label }}
              </el-dropdown-item>
            </el-dropdown-menu>
          </template>
      ...
      <div class="big-data-down-left">
        ...
        <div class="flex-warp-item">
          <div class="flex-warp-item-box">
            ...
            <div ref="rightChartData1" class="flex-content" />
          </div>
        </div>
      </div>
      ...
      <div class="big-data-down-center">
        <div class="big-data-down-center-one">
          <div ref="rightChartData5" class="big-data-down-center-one-content">
            <div id="3DEarth" />
            <div
              v-for="(v, k) in state.earth3DBtnList"
              :key="k"
              :class="v.topLevelClass"
            >
              <div v-for="i in 4" :key="i" class="circle" />
              <div class="text-box">
          ...
          <div class="flex-warp-item-box">
            ...
            <div class="flex-content">
              <div class="flex-content-left">
                <div
                  v-for="(v, k) in state.chartData4List"
                  :key="k"
                  class="monitor-item"
                >
                  <div
              ...
              <div ref="rightChartData4" class="flex-content-right" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="big-data-down-right">
        <div class="flex-warp-item">
          <div class="flex-warp-item-box">
            ...
            <div ref="rightChartData3" class="flex-content" />
          </div>
        </div>
        <div class="flex-warp-item">
          <div class="flex-warp-item-box">
            ...
            <div class="flex-content">
              ...
              <div ref="rightChartData6" class="progress" />
            </div>
          </div>
        </div>
        <div class="flex-warp-item">
          <div class="flex-warp-item-box">
            ...
            <div ref="rightChartData2" class="flex-content" />
          </div>
        </div>
      </div>
    </div>
...
const init3DEarth = (globeRadius: any) => {
  const el = <HTMLElement>document.querySelector('#3DEarth')
  ...
  .big-data-up {
    ...
    .up-center {
      ...
      &::after {
        ...
        border-image: linear-gradient(to right, rgba(0, 0, 0, 0.1), #43bdf0) 1
          10;
      }
      span {
        cursor: pointer;
