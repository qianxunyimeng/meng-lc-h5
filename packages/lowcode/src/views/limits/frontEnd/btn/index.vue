<template>
  <div class="layout-pd">
    ...
    <el-card shadow="hover" header="演示1：组件方式" class="mt15">
      <el-row class="mb10" style="color: #808080"
        >单个权限验证（:value="xxx"）：</el-row
      >
      <div class="flex-warp">
        <Auth :value="'btn.add'">
      ...
      <el-row class="mb10 mt10" style="color: #808080"
        >多个权限验证，满足一个则显示（:value="[xxx,xxx]"）：</el-row
      >
      <div class="flex-warp">
      ...
      <el-row class="mb10 mt10" style="color: #808080"
        >多个权限验证，全部满足则显示（:value="[xxx,xxx]"）：</el-row
      >
      <div class="flex-warp">
    ...
    <el-card
      shadow="hover"
      header="演示2：指令方式（页面初始化时执行）"
      class="mt15"
    >
      <el-row class="mb10" style="color: #808080"
        >单个权限验证（v-auth="xxx"）：</el-row
      >
      <div class="flex-warp">
        <div v-auth="'btn.add'" class="flex-warp-item">
          <div class="flex-warp-item-box">
            <el-button type="primary" size="default">
              <el-icon>
                <ele-DocumentAdd />
        ...
        <div v-auth="'btn.edit'" class="flex-warp-item">
          <div class="flex-warp-item-box">
            <el-button type="info" size="default">
              <el-icon>
                <ele-Edit />
        ...
        <div v-auth="'btn.del'" class="flex-warp-item">
          <div class="flex-warp-item-box">
            <el-button type="danger" size="default">
              <el-icon>
                <ele-Delete />
        ...
        <div v-auth="'btn.link'" class="flex-warp-item">
          <div class="flex-warp-item-box">
            <el-button type="success" size="default">
              <el-icon>
                <ele-Link />
      ...
      <el-row class="mb10 mt10" style="color: #808080"
        >多个权限验证，满足一个则显示（v-auths="[xxx,xxx]"）：</el-row
      >
      <div class="flex-warp">
        <div
          v-auths="['btn.addsss', 'btn.edit', 'btn.delsss', 'btn.linksss']"
        ...
        <div
          v-auths="['btn.add', 'btn.edit', 'btn.del', 'btn.link']"
          class="flex-warp-item"
        >
          <div class="flex-warp-item-box">
            <el-button type="info" size="default">
      ...
      <el-row class="mb10 mt10" style="color: #808080"
        >多个权限验证，全部满足则显示（v-auth-all="[xxx,xxx]"）：</el-row
      >
      <div class="flex-warp">
        <div
          v-auth-all="['btn.add', 'btn.edit', 'btn.del', 'btn.link']"
          class="flex-warp-item"
        >
          <div class="flex-warp-item-box">
            <el-button type="primary" size="default">
    ...
    <el-card
      shadow="hover"
      header="演示3：函数方式（点击按钮查看有无权限，用于判断）"
      class="mt15"
    >
      <el-row class="mb10" style="color: #808080"
        >auth('xxx')、auths(['xxx','xxx'])、authAll(['xxx','xxx'])：</el-row
      >
      <div class="flex-warp">
        <div class="flex-warp-item">
          <div class="flex-warp-item-box">
...
// 引入组件
const LimitsFrontEndPage = defineAsyncComponent(
  () => import('/@/views/limits/frontEnd/page/index.vue')
)
...
const AuthAll = defineAsyncComponent(
  () => import('/@/components/auth/authAll.vue')
)
