        ...
        <div class="big-data-down-left">
              ...
              <div class="flex-content flex-content-overflow">
                ...
                <div class="d-btn">
                  <div
                    ...
                    class="d-btn-item"
                  >
                    <i class="d-btn-item-left el-icon-money" />
          ...
          <div class="flex-warp-item">
            <div class="flex-warp-item-box">
              ...
              <div class="flex-content">
                <div ref="chartsWarningRef" style="height: 100%" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="big-data-down-center">
          <div class="big-data-down-center-one">
            <div class="big-data-down-center-one-content">
              <div ref="chartsCenterOneRef" style="height: 100%" />
            </div>
          </div>
            ...
            <div class="flex-warp-item-box">
              ...
              <div class="flex-content">
                ...
                <div class="flex-content-right">
                  <div ref="chartsMonitorRef" style="height: 100%" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="big-data-down-right">
          <div class="flex-warp-item">
            <div class="flex-warp-item-box">
              ...
              <div class="flex-content">
                <div ref="chartsSevenDaysRef" style="height: 100%" />
              </div>
            </div>
          </div>
          <div class="flex-warp-item">
                ...
                <div class="progress">
                  <div class="progress-item">
                    ...
                    <div class="progress-box">
                      <el-progress :percentage="70" color="#43bdf0" />
                    </div>
                  </div>
                  <div class="progress-item">
                    <span>施药率</span>
                    <div class="progress-box">
                      <el-progress :percentage="36" color="#43bdf0" />
                    </div>
                  </div>
                  <div class="progress-item">
                    <span>农事率</span>
                    <div class="progress-box">
                      <el-progress :percentage="91" color="#43bdf0" />
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="flex-warp-item">
            <div class="flex-warp-item-box">
              ...
              <div class="flex-content">
                <div ref="chartsInvestmentRef" style="height: 100%" />
              </div>
            </div>
          </div>
        </div>
