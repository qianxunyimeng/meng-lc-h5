<template>
  <div class="workflow-drawer-node">
    <el-tabs v-model="state.tabsActive" type="border-card">
      <!-- 节点编辑 -->
          ...
          >
            ...
            >
              ...
              >
                ...
                <el-checkbox label="统计分析" name="type" />
              </el-checkbox-group>
            </el-form-item>
            <el-form-item>
      ...
      <el-tab-pane label="图表可视化" name="3">
        <el-scrollbar>
          <div class="flex-content-right">
            <div ref="chartsMonitorRef" style="height: 200px; width: 320px" />
          </div>
        </el-scrollbar>
      </el-tab-pane>
    </el-tabs>
...
const initChartsMonitor = () => {
  ...
  for (let i = 0; i < 7; i++) {
    numsOne.push(
      `${Math.floor(Math.random() * 52 + 10)}:${Math.floor(
        Math.random() * 52 + 1
      )}`
    )
