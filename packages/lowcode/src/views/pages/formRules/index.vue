<template>
  <div class="form-rules-container layout-pd">
    <el-card shadow="hover" header="表单组件1">
      <FormRulesOne ref="pagesFormRulesOneRef" :data="state.formRulesOneData"
    /></el-card>
...
// 引入组件
const FormRulesOne = defineAsyncComponent(
  () => import('/@/views/pages/formRules/component/formRulesOne.vue')
)
const FormRulesTwo = defineAsyncComponent(
  () => import('/@/views/pages/formRules/component/formRulesTwo.vue')
)
const FormRulesThree = defineAsyncComponent(
  () => import('/@/views/pages/formRules/component/formRulesThree.vue')
)
